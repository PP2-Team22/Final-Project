...
public class sortUtil {
    ...
    public Comparator<Crash>comparing_operator = Comparator.comparing(Crash::getLocation);
    ...
    public Comparator<Crash>comparing_aboard  = Comparator.comparing(Crash::getAboardCnt);
    public Comparator<Crash>comparing_fatalities = Comparator.comparing(Crash::getFatalitiesCnt);
    public Comparator<Crash>comparing_ground = Comparator.comparing(Crash::getGroundCnt);
    public Comparator<Crash>comparing_survivors = Comparator.comparing(Crash::getSurvivorsCnt);
